<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditBanner.aspx.cs" Inherits="EditBanner" %>
<%@ Register Src="~/AdminHeader.ascx" TagPrefix="ah" TagName="Header" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit Banner Images</title>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <label>Recent Banner Image 1</label><br />
                                                <asp:Image ID="Image1" runat="server" Width="250" Height="100" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Recent Banner Image 2</label><br />
                                                <asp:Image ID="Image2" runat="server" Width="250" Height="100" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Recent Banner Image 3</label><br />
                                                <asp:Image ID="Image3" runat="server" Width="250" Height="100" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Recent Banner Image 4</label><br />
                                                <asp:Image ID="Image4" runat="server" Width="250" Height="100" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Recent Banner Image 5</label><br />
                                                <asp:Image ID="Image5" runat="server" Width="250" Height="100" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <asp:Button ID="btnUpdateBanner" OnClick="btnUpdateBanner_Click" CssClass="btn btn-success" runat="server" Text="Submit" Style="border: 0;" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
