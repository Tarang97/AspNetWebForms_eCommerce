<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeImgSlider.aspx.cs" Inherits="HomeImgSlider" %>
<%@ Register Src="~/AdminHeader.ascx" TagPrefix="ah" TagName="Header" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Home Page Image Slider</title>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <asp:Button ID="btnAddImage" OnClick="btnAddImage_Click" CssClass="btn btn-success" runat="server" Text="Submit" style="border:0;" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
