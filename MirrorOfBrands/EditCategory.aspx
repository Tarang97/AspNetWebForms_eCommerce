                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtUpdateCategory" CssClass="form-control" runat="server"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <asp:Button ID="btnUpdateCat" runat="server" Text="Update" CssClass="btn btn-success" OnClick="btnUpdateCat_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
