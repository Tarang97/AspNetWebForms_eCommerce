<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddGender.aspx.cs" Inherits="AddGender" %>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="This Field is Required!" ControlToValidate="txtGenderName" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                                ...
                                                <asp:Repeater ID="rptrGender" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href='AddGender.aspx?gid=<%# Eval("GenderID") %>'>
                                                                    <asp:Button ID="btnGDelete" runat="server" CssClass="btn btn-warning" OnClick="btnGDelete_Click" ToolTip="Delete Gender" Text="Delete" /></a></td>
                                                        </tr>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        </tbody>
